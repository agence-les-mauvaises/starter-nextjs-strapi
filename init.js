...
(async () => {
    const projectName = await prompts({
        ...
        initial: packageJson.name || "my-project",
    });
        ...
        const url = new URL(
            (
                await prompts({
                    ...
                    initial: app === "NEXT_PUBLIC_API_URL" ? "http://127.0.0.1:1337" : app === "NEXT_PUBLIC_APP_URL" ? "http://127.0.0.1:3000" : `http://127.0.0.1:300${index + 1}`,
